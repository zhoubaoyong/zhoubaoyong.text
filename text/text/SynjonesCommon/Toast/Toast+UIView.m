...
// activity
static const CGFloat CSToastActivityWidth       = 80;
static const CGFloat CSToastActivityHeight      = 80;
...
- (void)makeToastActivity:(id)position {
    ...
    activityIndicatorView.center = CGPointMake(activityView.bounds.size.width / 2, activityView.bounds.size.height / 2 - 5);
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, activityView.bounds.size.height - 30, activityView.bounds.size.width, 30)];
    label.text = @"请稍后";
//    label.text = MESSAGE;
